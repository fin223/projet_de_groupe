<?php 
    session_start();
    require_once 'Projet_Login_config.php'; // ajout connexion bdd 
    
   // si la session existe pas soit si l'on est pas connecté on redirige
    if(!isset($_SESSION['user'])){
        header('Location:Projet_Login_index.php');
        die();
    }
...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-center">
        ...
        <?php echo require 'Projet_Accueil_Prototype.php'; ?>
            <hr />
                <a href="Projet_Login_deconnexion.php" class="btn btn-danger btn-lg">Déconnexion</a>
        ...
        <div class="modal fade" id="change_password" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="Projet_Login_change_password.php" method="POST">
            ...
            <!-- heu ???? partie qui sert a rien j'ai l'impression :x -->
